...
# URL của trang web
url = 'https://thuvienphapluat.vn/van-ban/Tai-nguyen-Moi-truong/Nghi-dinh-13-2011-ND-CP-an-toan-cong-trinh-dau-khi-118681.aspx'
...
if noi_dung_link:
    ...
    if content_div:
        ...
        # Nghị định: (Chương, Điều, khoản) - (Điều, khoản)
